  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <div className="truncate font-medium">{event.title}</div>
        <Badge variant="outline" className="text-xs px-1 py-0 rounded-md">
          work
        </Badge>
        <Badge className="text-xs px-1 py-0 rounded-md bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border-gray-300">
          To Do
        </Badge>
        <Badge className="text-xs px-1 py-0 rounded-md bg-red-100 text-red-700 border border-red-400 dark:bg-red-900/30 dark:text-red-300 dark:border-red-700">
          High
        </Badge>
      </div>
        ...
        }
        {
          <>
            ...
            <span className="flex items-center text-red-500">
              <TriangleAlert className="h-3 w-3 mr-1" /> Missed
            </span>
          </>
        }
      </div>
